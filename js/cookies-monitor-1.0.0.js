var CookiesMonitor = (function () {
    ...
    var lgpdCookie, lgpdCookieIsDefault = true, globalConfig, cookieConsentLoading = false, domainTopCookie = getDomain();
    ...
    var deleteCookie = function (name, type) {
        try {
            ...
            if (type === 'cookies') {
                ...
                document.cookie = name + '=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;domain=' + domainTopCookie;
            }
        }
        catch (e) {
            sendGAErrors(e);
    ...
    var sendError = function (error) {
        console.log('Ocorreu erro ao realizar o monitoramento de cookies: ' + error);
        sendGAErrors(e);
    };
    var lgpdCookieDefault = function () {
        try {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", globalConfig.basePathAssetsJS + globalConfig.categorizedCookiesJsonURL, true);
            xhr.send();
    ...
    try {
        document.querySelectorAll('.js-open-cookies-management').forEach(function (el) {
